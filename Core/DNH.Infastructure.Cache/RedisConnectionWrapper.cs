...
namespace DNH.Infastructure.Cache
{
    public class RedisConnectionWrapper : IRedisConnectionWrapper, ILocker
    {
        ...
        private readonly Lazy<string> _connectiostring;
        ...
        {
            this._config = config;
            this._connectiostring = new Lazy<string>(GetConnectiostring);
        ...
        /// </summary>
        /// <returns></returns>
        protected string GetConnectiostring()
        {
        ...
        protected ConnectionMultiplexer GetConnection()
        {
            ...
            lock (_lock)
            {
                ...
                _connection = ConnectionMultiplexer.Connect(_connectiostring.Value);
            }
        ...
        protected RedLockFactory CreateRedisLockFactory()
        {
            ...
            var configurationOptions = ConfigurationOptions.Parse(_connectiostring.Value);
